        ...
        <div class="main-content">
            ...
            <div id="dashboard-content" class="content-section active">
                ...
                <div class="forms-container">
                    <!-- Pending Advertisements Component -->
                    <div class="adds-container">
                        <h3>Pending Advertisements</h3>
                        <table>
                            <thead>
                                <tr>
                                    <th>Seller Name</th>
                            ...
                            <tbody id="pendingAdsTableBody">
                                <?php
                                // Fetch pending advertisements
                                $pendingAdsQuery = $con->query("
                                    SELECT 
                                        a.ad_id,
                                        u.first_name AS seller_name,
                                        gc.category_name,
                                ...
                                ");
                                $pendingAds = $pendingAdsQuery->fetch_all(MYSQLI_ASSOC);
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="4">No pending advertisements found.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
